...
public class XmlParser {
    ...
    public XmlParser(Class... classesToBeBound) {
        try {
            ...
            marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, true);     // форматирование с отступами
            marshaller.setProperty(Marshaller.JAXB_ENCODING, "UTF-8");          // тип кодировки
