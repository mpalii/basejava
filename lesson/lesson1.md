...
- Реализуйте класс `ru.javaops.HW1HW2HW3.webapp.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
- Протестируйте вашу реализацию с помощью классов `ru.javaops.HW1HW2HW3.webapp.MainArray.main()` и `ru.javaops.HW1HW2HW3.webapp.test.MainTestArrayStorage.main()`
...
1. `ru.javaops.HW1HW2HW3.webapp.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
